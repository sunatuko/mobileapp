...
btn1.addEventListener("click",
    function () {
        ...
        console.log(n); //★consoleに変数nの値を出力する。
        btn1.textContent = resultText[n];
        btn1.style.color = resultColor[n];
        btn1.style.fontSize = resultFontSize[n];
        console.log(btn1.textContent);//★consoleに変数の値を出力する。
        console.log(btn1.style.color);//★consoleに変数の値を出力する。
        console.log(btn1.style.fontSize);//★consoleに変数の値を出力する。
        // snowfall stop
